...
Telegram бот для генерации изображений с помощью DALL-E 3 и автоматической загрузки на стоковые площадки (123RF). Работает в связке с Backend API.
...
- Настройка стоковых сервисов через inline клавиатуры
- Тестирование соединений с сервисами
...
- `/mystocks` - Управление настройками стоковых сервисов
