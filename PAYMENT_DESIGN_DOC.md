...
```javascript
const paymentParams = {
  receiver: '123_YOOMONEY_WALLET',        // Номер кошелька
...
**Пример ссылки:**
```
https://yoomoney.ru/quickpay/confirm.xml?receiver=123_YOOMONEY_WALLET&quickpay=shop&targets=Пополнение+счета+AI+Bot&paymentType=SB&sum=100&label=ai_bot_12345_1699123456
```
...
### Шаг 5: Изменения в Telegram Bot 
...
# YooMoney settings
YOOMONEY_WALLET=123_YOOMONEY_WALLET
