...
RESTful API backend для AI Stock Bot - системы генерации изображений с помощью DALL-E 3, Flux (Segmind) и автоматической загрузки на стоковую площадку 123RF.
...
SEGMIND_API_KEY=your_segmind_api_key  # Для Flux модели
...
#### ImageService
- Генерация изображений через OpenAI DALL-E 3 и Segmind Flux
